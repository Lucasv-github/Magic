...
tellraw @s ["",{"text":"That is right your mana decreased","bold":true,"color":"gold"},"\n","\n",{"text":"If your mana gets to zero you will have to reopen Magic","bold":true,"color":"gold"},"\n","\n",{"text":"To increase your mana you use a ender eye, bringing the stack to above 32","bold":true,"color":"gold"},{"text":" then you deselect that slot","bold":true,"color":"dark_red"}]