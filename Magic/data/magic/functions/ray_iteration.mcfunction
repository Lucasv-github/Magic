...
execute as @s[scores={t_1=3,t_2=3,t_3=1,t_4=3,t_5=3,t_6=1,t_7=3,t_8=3,t_9=0}] run particle minecraft:dust{color:[0.3373, 0.3373, 1.0], scale:1.0} ~ ~2 ~ 0 0 0 0 10 normal
