...
execute as @s[scores={t_1=5,t_2=5,t_3=3,t_4=5,t_5=5,t_6=3,t_7=5,t_8=5,t_9=0}] store result score Temp reg_1 run fill ~ ~ ~ ~ ~ ~ air replace #magic:balefire_destroyable
...
execute as @s[scores={t_1=3,t_2=3,t_3=1,t_4=3,t_5=3,t_6=1,t_7=3,t_8=3,t_9=0}] run particle minecraft:dust 1 0.3373 0.3373 1.0 ~ ~2 ~ 0 0 0 0 10 normal
execute as @s[scores={t_1=3,t_2=3,t_3=1,t_4=3,t_5=3,t_6=1,t_7=3,t_8=3,t_9=0}] store result score Temp reg_1 run fill ~ ~ ~ ~ ~ ~ air replace #magic:balefire_destroyable
...
execute unless entity @s[distance=..5] as @s[scores={t_1=3,t_2=3,t_3=1,t_4=3,t_5=3,t_6=1,t_7=3,t_8=3,t_9=0}] unless entity @e[type=minecraft:fireball,distance=..2] run summon fireball ~ ~1 ~ {ExplosionPower:2,Motion:[0.0,-10.0,0.0]}
...
execute if entity @s[distance=..200] if score Ray_data reg_2 matches 1 positioned ^ ^ ^0.5 run function magic:ray_iteration