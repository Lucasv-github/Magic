...
execute positioned as @s in magic:tar run clone from minecraft:overworld ~15 -64 ~15 ~ 319 ~ to magic:tar ~ -64 ~
execute if score Temp reg_3 matches 0 positioned as @s in minecraft:overworld run forceload remove ~ ~
execute positioned as @s in magic:tar run forceload remove ~ ~
