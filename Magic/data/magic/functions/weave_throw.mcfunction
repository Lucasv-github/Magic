...
execute at @a[tag=thrower] as @e[tag=!thrower,limit=1,distance=..10,type=!armor_stand,type=!snowball,sort=nearest] run ride @s mount @e[limit=1,sort=nearest,type=minecraft:snowball]
