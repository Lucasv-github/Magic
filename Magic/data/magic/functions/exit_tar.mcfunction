function magic:tar_load_inventory

#Will also be ran if you have already exited as a cleanup
execute if dimension magic:tar in minecraft:overworld run tp @s ~ ~ ~
...
execute if dimension magic:tar in minecraft:overworld run function magic:teleport
