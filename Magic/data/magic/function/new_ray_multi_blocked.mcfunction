################################################################################
#Purpose: Make sure you cannot land a weave multiple times
#Runner: Entities when they aim and fire a weave against something the first time
#Return values:
#Authors: Lprogrammer
################################################################################
...
#Want to tag based on what weave contains without having to traverse and scan
#Non player bypass for weave components
...
#Can't do this iteratively (which would be best of course) as that would burn lots of computational power
