...
$execute if score Temp reg_1 matches 1.. if entity @s[distance=1..] facing entity @s eyes positioned ^ ^ ^$(size) run function magic:weave_actions/build_bridge with storage magic:weave_size