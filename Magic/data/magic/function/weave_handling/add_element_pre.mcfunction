...
execute unless data entity @s[scores={a=1..}] {Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{Magic:1}}}]} run give @s[scores={use_items_current=1..2}] minecraft:carrot_on_a_stick[enchantment_glint_override=1b,custom_name=[{"text":"Air","italic":false,"color":"aqua"}],lore=[[{"text":"One of the 5 elements","italic":false}]],minecraft:item_model="magic_resourcepack:air",custom_data={Magic:1,Magic_interaction:1b}] 1
execute unless data entity @s[scores={e=1..}] {Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{Magic:2}}}]} run give @s[scores={use_items_current=1..2}] minecraft:carrot_on_a_stick[enchantment_glint_override=1b,custom_name=[{"text":"Earth","italic":false,"color":"dark_green"}],lore=[[{"text":"One of the 5 elements","italic":false}]],minecraft:item_model="magic_resourcepack:earth",custom_data={Magic:2,Magic_interaction:1b}] 1
execute unless data entity @s[scores={f=1..}] {Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{Magic:3}}}]} run give @s[scores={use_items_current=1..2}] minecraft:carrot_on_a_stick[enchantment_glint_override=1b,custom_name=[{"text":"Fire","italic":false,"color":"red"}],lore=[[{"text":"One of the 5 elements","italic":false}]],minecraft:item_model="magic_resourcepack:fire",custom_data={Magic:3,Magic_interaction:1b}] 1
execute unless data entity @s[scores={w=1..}] {Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{Magic:4}}}]} run give @s[scores={use_items_current=1..2}] minecraft:carrot_on_a_stick[enchantment_glint_override=1b,custom_name=[{"text":"Water","italic":false,"color":"dark_blue"}],lore=[[{"text":"One of the 5 elements","italic":false}]],minecraft:item_model="magic_resourcepack:water",custom_data={Magic:4,Magic_interaction:1b}] 1
execute unless data entity @s[scores={s=1..}] {Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{Magic:5}}}]} run give @s[scores={use_items_current=1..2}] minecraft:carrot_on_a_stick[enchantment_glint_override=1b,custom_name=[{"text":"Spirit","italic":false,"color":"white"}],lore=[[{"text":"One of the 5 elements","italic":false}]],minecraft:item_model="magic_resourcepack:spirit",custom_data={Magic:5,Magic_interaction:1b}] 1
