execute in minecraft:overworld run setblock 0 0 0 oak_sign{front_text:{messages:['["WELLED: ",{"selector":"@e[tag=current_player_for_log,limit=1]"}," Current: ",{"score":{"name":"@e[tag=current_player_for_log,limit=1]","objective":"well_amount"}}]','{"text":""}','{"text":""}','{"text":""}']}} destroy
