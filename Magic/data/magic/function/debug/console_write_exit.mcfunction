execute in minecraft:overworld run setblock 0 0 0 oak_sign{front_text:{messages:['["EXITED: ",{"selector":"@e[tag=current_player_for_log,limit=1]"}," Held: ",{"score":{"name":"@e[tag=current_player_for_log,limit=1]","objective":"current_held"}}]','{"text":""}','{"text":""}','{"text":""}']}} destroy
