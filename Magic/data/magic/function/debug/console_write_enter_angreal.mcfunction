execute in minecraft:overworld run setblock 0 0 0 oak_sign{front_text:{messages:['["ANGREALED: ",{"selector":"@a[tag=current_player_for_log,limit=1]"}," Level: ",{"score":{"name":"@a[tag=current_player_for_log,limit=1]","objective":"angreal_level"}}]','{"text":""}','{"text":""}','{"text":""}']}} destroy
