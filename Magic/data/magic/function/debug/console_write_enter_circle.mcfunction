execute in minecraft:overworld run setblock 0 0 0 oak_sign{front_text:{messages:['["CIRCLED: ",{"selector":"@a[tag=current_player_for_log,limit=1]"}," Owner: ",{"score":{"name":"@a[tag=current_player_for_log,limit=1]","objective":"circled_owner_id"}}]','{"text":""}','{"text":""}','{"text":""}']}} destroy
