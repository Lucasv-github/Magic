...
execute in minecraft:overworld positioned 0 0 0 run summon minecraft:text_display ~ ~ ~ {Tags:["console_writer_new"],text:["",{text:"OPENED: "},{selector:"@e[tag=current_player_for_log,limit=1]"},{text:" Draw: "},{score:{name:"@e[tag=current_player_for_log,limit=1]",objective:"current_draw"}}]}
