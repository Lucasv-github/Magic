...
tag @a[tag=temp_remove_circle,tag=next_sever] remove can_use
tag @a[tag=temp_remove_circle,tag=next_sever] add stilled
tag @a[tag=temp_remove_circle] remove next_sever
