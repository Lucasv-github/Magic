...
execute if score Temp reg_1 matches 1.. run data modify entity @e[tag=create_angreal_current,limit=1] Item.components.minecraft:custom_data merge value {Angreal_top:1}
execute if score Temp reg_1 matches 1.. run data modify entity @e[tag=create_angreal_current,limit=1] Item.components.minecraft:custom_data merge value {Enchantments:[{}]}
execute if score Temp reg_1 matches 1.. run data modify entity @e[tag=create_angreal_current,limit=1] Item.components.minecraft:custom_data merge value {Amplification:0}
