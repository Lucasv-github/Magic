...
execute as @s[tag=!exit_reason_shielded] if score magic_settings magic_debug_state matches 2 run function magic:debug/console_write_exit
execute as @s[tag=exit_reason_shielded] if score magic_settings magic_debug_state matches 2 run function magic:debug/console_write_shielded_exit
...
execute as @s[type=player] run function magic:weave_handling/weave_copies_clear with storage magic:weave_copies_clear
