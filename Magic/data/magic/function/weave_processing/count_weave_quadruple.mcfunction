...
#Arguments: Temp reg_1: element_1 Temp reg_2: element_2 Temp reg_3: element_3 Temp reg_4
#Runner: An armorstand decoding its contained weave and counting 4 element combinations
