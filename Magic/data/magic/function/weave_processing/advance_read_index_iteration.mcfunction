...
execute store result storage magic:weave_processing/advance_read_index_iteration i int 1 run scoreboard players get @s reg_3
...
execute if score @s reg_2 matches 1.. run function magic:weave_processing/advance_read_index_iteration with storage magic:weave_processing/advance_read_index_iteration