...
execute as @s as @a[tag=using,tag=can_use] if score @s player_id = Temp reg_1 run function magic:player_remove_weave with storage minecraft:remove_weave_index
