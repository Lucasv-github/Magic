################################################################################
#Purpose: Change the selected shield for countering for @s and display any active shields to @s
#Runner: A player who wants to change which shield they are countering, run via power_handing/tap_power.mcfunction
#Return values:
#Authors: Lprogrammer
################################################################################
...
tag @e[type=minecraft:armor_stand,tag=display_shelds_change_temp,tag=shield_counter_selected_old] remove shield_counter_selected
