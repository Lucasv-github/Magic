...
execute as @e[type=minecraft:armor_stand,tag=target_point,tag=actively_held,tag=!hold_used] if score @s player_id = Temp reg_1 run function magic:cleanup/remove_cleanup
