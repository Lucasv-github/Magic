...
execute if score Temp reg_1 matches 1 run item modify entity @s weapon.mainhand {"type":"minecraft:set_components","components":{"minecraft:item_model":"magic_resourcepack:adam","minecraft:custom_data":{"Magic_ter_adam":0}}}